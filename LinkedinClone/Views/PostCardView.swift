...
let samplePostData = PostData(id: 1, Image: "02", title: "Sumukh Aradhya", followers: 500, profileImage: "1")
...
struct PostCardView: View {
    ...
    var body: some View {
        ...
        Rectangle()
            ...
            Text("looking for a new course in iOS with swift UI, you are already in a good place.")
            Image(data.Image)
                .resizable()
                .aspectRatio(contentMode: .fit)
